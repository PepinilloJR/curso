...
async function Recibir_imagenes(setImagenes) {
    try {
        //const ruta = './xd.mp4'
        const nombre = "foto1"
        const response = await fetch(`http://localhost:1234/imagenes?nombre=${nombre}`)
...
async function Postear_imagen() {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:1234/imagenes`, {
            method: 'POST',
            headers: {
...
async function Modificar_imagen() {
    ...
    try {
        ...
        const esGrandeA = 'false'
        const response = await fetch(`http://localhost:1234/imagenes/6`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function Eliminar_imagen() {
    ...
    try {
        const response = await fetch(`http://localhost:1234/imagenes/5`, {
            method: 'DELETE'
        })
    } catch (err) {
        console.log(err)
